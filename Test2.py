# We will calculate the cost of insurance for a 35-year-old male who smokes, has 2 children, and a BMI of 27.3
age = 35
smoker = 1   # 0 for a non-smoker, 1 for a smoker
sex = 1   # 0 for female, 1 for male (assigned gender at birth)
bmi = 27.3
num_of_children = 2
...
print('The change in estimated cost for being female instead of male is', change_in_insurance_cost, 'dollars.\n')
...
print('The change in estimated cost for being a nonsmoker is', change_in_insurance_cost, 'dollars.\n')
